...
class FileInfoExport implements FromArray, WithHeadings
{
    ...
    public function headings(): array
    {
       ...
       return ['Invoice no', 'Email timestamp', 'Bill to GST', 'Ship to Code', 'Ship to Customer Name', 'P1 Code', 'P1 Description', 'P1 Quantity', 'P2 Code', 'P2 Description', 'P2 Quantity', 'Attachment'];
