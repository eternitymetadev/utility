...
class FileInfoExport implements FromArray, WithHeadings
{
    ...
    public function headings(): array
    {
       ...
       return ['Invoice no', 'Email timestamp', 'Bill to GST', 'Attachment','Ship to Code', 'Ship to Customer Name', 'P1 Code', 'P1 Description', 'P1 Quantity', 'P2 Code', 'P2 Description', 'P2 Quantity', 'P3 Code', 'P3 Description', 'P3 Quantity', 'P4 Code', 'P4 Description', 'P4 Quantity', 'P5 Code', 'P5 Description', 'P5 Quantity'];
